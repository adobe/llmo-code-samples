...
*/
/**
 * Edge Optimize BYOCDN - Vercel Pages Router API Route
 *
 * Catch-all edge API route that proxies agentic requests to the Edge Optimize
 ...
 *
 * Route: /api/adobe-edgeoptimize/* → https://live.edgeoptimize.net/*
 *
...
// Run as a Vercel Edge Function (not a Node.js serverless function)
...
export default async function handler(request) {
  ...
  // Failover: fetch from the default Vercel origin using the original path
  if (shouldFallback) {
    try {
